    ...
    openBtn.MouseButton1Click:Connect(function()
        ...
        local function buildQueue(list)
            for _,e in ipairs(list) do
                ...
                if typ=="section" then
                    local l=Instance.new("TextLabel") l.Text=a.name or "" l.Size=UDim2.new(1,0,0,18) l.BackgroundTransparency=1 l.TextColor3=Color3.fromRGB(180,180,180) l.Font=Enum.Font.Gotham l.TextSize=12 l.Parent=scroll
                elseif typ=="toggle" then
                    ...
                    local function upd(v) if v~=nil then state=v end b.Text=a.name..(state and ": ON" or ": OFF") b.BackgroundColor3=state and Color3.fromRGB(0,170,90) or Color3.fromRGB(50,50,55) end
                    o._upd = upd
                    b.MouseButton1Click:Connect(function() state=not state upd() pcall(a.callback,state) end)
                    -- init callback with default
