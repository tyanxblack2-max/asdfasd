...
-- Hub icon — на Delta скипаем (трогает CoreGui → Plugin)
if not IS_DELTA then
pcall(function()
...
print("[Test3] UI done, loops disabled for test - check Rcoin")
-- early exit for test - no farming logic
do return end
